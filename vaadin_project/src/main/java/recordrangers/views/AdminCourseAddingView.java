...
public class AdminCourseAddingView extends AdminCourseSearchView {
    private final Button dropButton = new Button("Delete Course");

    public AdminCourseAddingView() throws SQLException{
